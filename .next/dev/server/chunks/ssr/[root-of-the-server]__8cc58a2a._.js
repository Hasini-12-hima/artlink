...
;
const metadata = {
    title: "ArtLink Hub - Discover & Connect with Artists",
    description: "Discover exceptional artwork and connect directly with talented artists. A marketplace for creativity.",
    generator: "v0.app",
    icons: {
        icon: [
            {
